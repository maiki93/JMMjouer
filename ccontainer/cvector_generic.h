...
/*SHARED_EXPORT ccontainer_err_t cvector_gen_copy(cvector_gen_t* cvect_dest, cvector_gen_t* cvect_src);*/
...
SHARED_EXPORT ccontainer_err_t cvector_gen_set_capacity(cvector_gen_t *cvect, size_t new_size);

...
test_arcade: $(MODDIR_JMMJOUER_TESTS)/test_arcade.o $(OBJS_NO_ARCADE)  librecord libclogger libccontainer libjoueur libgame_pendu.dll
	@echo "Building test_arcade @ :    $@"  # target name
	$(CC) $(STD_TESTS) $(CFLAGS_TESTS) -o $@ $(MODDIR_JMMJOUER_TESTS)/test_arcade.o $(OBJS_NO_ARCADE) -L $(LIB_CMOCKA) -lcmocka -L. -l$(IMPORT_LIB_RECORD) -l$(IMPORT_LIB_CLOGGER) -l$(IMPORT_LIB_CCONTAINER) -l$(IMPORT_LIB_JOUEUR) -lgame_pendu_dll

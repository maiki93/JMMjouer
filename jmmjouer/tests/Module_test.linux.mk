...
test_arcade: $(MODDIR_JMMJOUER_TESTS)/test_arcade.o $(OBJS_NO_ARCADE) librecord libjoueur libccontainer libclogger libgame_pendu
	@echo "Building test_arcade @ :    $@"  # target name
	$(CC) $(STD_TESTS) $(CFLAGS) -o $@ $(MODDIR_JMMJOUER_TESTS)/test_arcade.o $(OBJS_NO_ARCADE) -L . -lrecord -ljoueur -lccontainer -lclogger -lgame_pendu -L $(LIB_CMOCKA) -lcmocka
